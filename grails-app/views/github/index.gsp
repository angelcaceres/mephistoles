...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Listado de githubs registrados.
                        </h1>
        ...
        <!-- /#page-wrapper -->
<div class="col-lg-6">
    <h2>Listado de githubs registrados</h2>
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            <g:each in="${githubs}" var="github" status="i">
                <tr>
                    <td>${github.gitUserName}</td>
                    <td>
                        <g:if test="${github.gitKey == true}">
                            Si.
                        </g:if>
                    <g:else>
                        No
