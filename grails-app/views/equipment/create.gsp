            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <g:hasErrors >
						...
						<label>Tipo.</label>
								<g:select class="form-control" name='type' from="${Equipment.constraints.type.inList}" 
          						noSelection="['':'Seleccione un tipo de la lista']"/>

                            <div class="form-group">
                                <label>Marca.</label>
                                <g:field type="text" name='make' class="form-control"  />
                                
								<label>Modelo.</label>
                                <g:field type="text" name='model' class="form-control" />
								<label>Número de serie.</label>
                                <g:field type="text" name='serialNumber' class="form-control" />
								<label>Fecha de adquisicion.</label>
                                <g:field type="date" name='dateOfPurchase' class="form-control" />
								<label>Precio.</label>
                                <g:field type="text" name='price' class="form-control" />
								<label>Foto.</label>
                                <g:field type="file" name='foto' id='foto' class="form-control" />
								<label>Usuario.</label>
