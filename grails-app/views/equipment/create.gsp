...
<html>
	...
	<body>
		<a href="#create-equipment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-equipment" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:equipmentInstance, action:'save']"  enctype="multipart/form-data">
				<fieldset class="form">
