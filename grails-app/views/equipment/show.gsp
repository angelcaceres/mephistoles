...
<div class="col-lg-6">
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                <tr>
                    <td>${equipmentInstance.type}</td>
                    <td>${equipmentInstance.make}</td>
                    <td>${equipmentInstance.model}</td>
                    <td>${equipmentInstance.serialNumber}</td>
                    <td><g:formatDate format="yyyy-MM-dd" date="${equipmentInstance.dateOfPurchase}"/></td>                    
                    <td> <img src="${createLink(action:'displayFoto', id:equipmentInstance?.id)}" width="200"/></td>                    
                </tr>
            </tbody>
        </table>
    </div>
