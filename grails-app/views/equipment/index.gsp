...
<div class="col-lg-6">
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            <g:each in="${equipments}" var="equipment" status="i">
                <tr>
                    <td>${equipment.type}</td>
                    <td>${equipment.make}</td>
                    <td>${equipment.model}</td>
                    <td>${equipment.serialNumber}</td>
                    <td><g:formatDate format="yyyy-MM-dd" date="${equipment.dateOfPurchase}"/></td>                    
                    <td> <img src="${createLink(action:'displayFoto', id:equipment?.id)}" width="200"/></td>                    
                </tr>
            </g:each>
            </tbody>
        </table>
