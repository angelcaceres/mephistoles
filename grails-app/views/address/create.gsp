            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ingresar cuenta dirección del empleado.
                        </h1>
                ...
                <div class="row">
                    ...
                    <g:hasErrors >
                        ...
                        <g:form contoller='Address' action='save' role="form">

                            <div class="form-group">
                                <label>Calle.</label>
                                <g:field type="text" name='street' class="form-control" />
                                
								<label>Número Exterior.</label>
                                <g:field type="number" name='houseNumber' class="form-control" />
								
								<label>Número interior.</label>
                                <g:field type="number" name='apartment' class="form-control" />
								
								<label>Colonia.</label>
                                <g:field type="text" name='locality' class="form-control" />

								<label>Ciudad.</label>
                                <g:field type="text" name='city' class="form-control" />

								<label>Estado.</label>
                                <g:field type="text" name='state' class="form-control" />

								<label>País.</label>
                                <g:field type="text" name='country' class="form-control" />

								<label>Tipo.</label>
                                <g:field type="text" name='type' class="form-control" placeholder="e.g. casa u oficina"/>

								<label>Código postal.</label>
                                <g:field type="number" name='zipCode' class="form-control" />
