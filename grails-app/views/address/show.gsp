...
<div class="table-responsive-xl">
        <table class="table table-bordered table-hover table-striped" width="100%" style="width: 100%;">
            <thead>
                <tr>
                    <th>Calle</th>
            ...
            <tbody>
                <tr>
                    <td>${addressInstance.street}</td>
                    <td>${addressInstance.houseNumber}</td>
                    <td>${addressInstance.apartment}</td>
                    <td>${addressInstance.locality}</td>
                    <td>${addressInstance.city}</td>
                    <td>${addressInstance.state}</td>
                    <td>${addressInstance.zipCode}</td>
                    <td>${addressInstance.type}</td>
                    <td>${addressInstance.user.firstName + ' ' +addressInstance.user.lastName}</td>
                </tr>
            </tbody>
        </table>
    </div>
