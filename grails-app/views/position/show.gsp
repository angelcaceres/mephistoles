        ...
        <table class="table table-bordered table-hover table-striped">
            <thead>
                <tr>
                    <th>Puesto</th>
                    <th>Salario</th>
                    <th>¿Es esta el puesto actual?</th>
					<th>Nombre del empleado</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>${positionInstance.position}</td>
                    <td>${positionInstance.salary}</td>
                    <td>
                        <g:if test="${positionInstance.current == true}">
                            Si.
                        </g:if>
                    <g:else>
                        No
					...
					<td>${positionInstance.user.firstName + ' ' + positionInstance.user.lastName}</td>
                </tr>
            </tbody>
        </table>
    </div>
