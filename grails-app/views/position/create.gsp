            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <g:hasErrors >
                        ...
                        <g:form contoller='Position' action='save' role="form">

                            <div class="form-group">
                                <label>Puesto.</label>
                                <g:field type="text" name='position' class="form-control" />
                                
								<label>Salario.</label>
                                <g:field type="number" name='salary' class="form-control" />

								<label>¿Es esta la posición actual?.</label>
                                <div class="checkbox">
                                    <label>
                                        <g:checkBox name='current' value="${true}"/>
                                    </label>
                                </div>
