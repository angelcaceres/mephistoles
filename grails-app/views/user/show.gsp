        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                <tr>
					...
					<td> <g:formatDate format="yyyy-MM-dd" date="${userInstance.startDate}"/></td>
                    <td><g:formatDate format="yyyy-MM-dd" date="${userInstance.birthDate}"/></td>
                    <td>${userInstance.homePhone}</td>
                    <td>${userInstance.cellPhoneNumber}</td>
                    <td>${userInstance.nss}</td>
                    <td>${userInstance.institutionalMail}</td>
                </tr>
